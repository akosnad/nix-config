        ...
        pkgs.writeShellApplication {
          ...
          text = ''
            ...
            getSystemPath() {
              ...
              nix-store --realise "$outPath" --no-fallback --max-silent-time 300 --timeout 1800 --option require-sigs false --option substituters '${builtins.concatStringsSep " " autoUpgradeSubstituters}'
            }
