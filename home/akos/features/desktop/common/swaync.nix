...
in
{
  services.swaync = {
    enable = true;
    style = /* css */ ''
      @define-color cc-bg rgba(${toRGB c.base00}, 0.7);
      @define-color noti-border-color rgba(255, 255, 255, 0.15);
      @define-color noti-bg rgba(${toRGB c.base00}, 0.8);
      @define-color noti-bg-opaque rgb(${toRGB c.base01});
      @define-color noti-bg-darker rgb(${toRGB c.base00});
      @define-color noti-bg-hover rgb(${toRGB c.base02});
      @define-color noti-bg-hover-opaque rgb(${toRGB c.base02});
      @define-color noti-bg-focus rgba(${toRGB c.base02}, 0.6);
      @define-color noti-close-bg rgba(${toRGB c.base07}, 0.1);
      @define-color noti-close-bg-hover rgba(${toRGB c.base07}, 0.15);
      @define-color text-color rgb(${toRGB c.base04});
      @define-color text-color-disabled rgb(${toRGB c.base07});
      @define-color bg-selected rgb(${toRGB c.base02});
